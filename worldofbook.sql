...
CREATE TABLE `orders` (
  ...
  `status` varchar(50) DEFAULT 'Pending', -- Các trạng thái: Pending, Processing, Completed, Cancelled
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
VALUES ('dinh1111', 'dinh1976@gmail.com', '$2y$10$S9G/N0U7rA.W76L.bH8eI.mBw688/A6zH6EBlwUvVdO2eN7hREdO.', 'admin');

ALTER TABLE users ADD COLUMN role VARCHAR(50) DEFAULT 'user' AFTER full_name;


INSERT INTO users (username, email, password_hash, full_name, role) 
VALUES ('admin', 'admin@worldofbook.com', '$2y$10$2xuhz4AYMFwUykm17keGgO4w3jUHMBIJSnOTq7F9c4UZZp7K68WkG', 'Administrator', 'admin');
