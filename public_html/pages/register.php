...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($stmt_check->rowCount() > 0) {
            ...
            // Tự động chuyển hướng sang trang login.php sau 2 giây
            ...
            <form id="mainRegisterForm" method="POST" action="register.php">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="username" class="form-control bg-light border-start-0" placeholder="Ít nhất 5 ký tự" minlength="5" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" class="form-control bg-light border-start-0" placeholder="viethung@example.com" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" name="password" class="form-control bg-light border-start-0" placeholder="Tối thiểu 8 ký tự" minlength="8" required>
                    </div>
                </div>
