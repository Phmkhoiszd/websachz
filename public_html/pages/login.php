...
<head>
    ...
    <title>Đăng Nhập - Sách Không Ngủ</title>
            ...
            <form id="mainLoginForm" method="POST" action="login.php">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="username" class="form-control bg-light border-start-0" id="loginUsername" placeholder="Nhập tên tài khoản hoặc email" required>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" name="password" class="form-control bg-light border-start-0" id="loginPassword" placeholder="Nhập mật khẩu của bạn" required>
                    </div>
